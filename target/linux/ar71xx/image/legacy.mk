...
e1700ac_mtdlayout_8M=mtdparts=spi0.0:256k(u-boot)ro,64k(u-boot-env)ro,6336k(rootfs),1472k(kernel),64k(art)ro,7744k@0x50000(firmware)
e1700ac_mtdlayout_16M=mtdparts=spi0.0:256k(u-boot)ro,64k(u-boot-env)ro,14528k(rootfs),1472k(kernel),64k(art)ro,16000k@0x50000(firmware)
e600g_mtdlayout_8M=mtdparts=spi0.0:256k(u-boot)ro,64k(u-boot-env)ro,6336k(rootfs),1472k(kernel),64k(art)ro,7744k@0x50000(firmware)
e600g_mtdlayout_16M=mtdparts=spi0.0:256k(u-boot)ro,64k(u-boot-env)ro,14528k(rootfs),1472k(kernel),64k(art)ro,16000k@0x50000(firmware)
e600gac_mtdlayout_8M=mtdparts=spi0.0:256k(u-boot)ro,64k(u-boot-env)ro,6336k(rootfs),1472k(kernel),64k(art)ro,7744k@0x50000(firmware)
e600gac_mtdlayout_16M=mtdparts=spi0.0:256k(u-boot)ro,64k(u-boot-env)ro,14528k(rootfs),1472k(kernel),64k(art)ro,16000k@0x50000(firmware)
...
$(eval $(call SingleProfile,AthLzma,64k,E1700AC_8M,e1700ac-8M,E1700AC,ttyS0,115200,$$(e1700ac_mtdlayout_8M),RKuImage))
$(eval $(call SingleProfile,AthLzma,64k,E1700AC_16M,e1700ac-16M,E1700AC,ttyS0,115200,$$(e1700ac_mtdlayout_16M),RKuImage))
$(eval $(call SingleProfile,AthLzma,64k,E600G_8M,e600g-8M,E600G,ttyS0,115200,$$(e600g_mtdlayout_8M),RKuImage))
$(eval $(call SingleProfile,AthLzma,64k,E600G_16M,e600g-16M,E600G,ttyS0,115200,$$(e600g_mtdlayout_16M),RKuImage))
$(eval $(call SingleProfile,AthLzma,64k,E600GAC_8M,e600gac-8M,E600GAC,ttyS0,115200,$$(e600gac_mtdlayout_8M),RKuImage))
$(eval $(call SingleProfile,AthLzma,64k,E600GAC_16M,e600gac-16M,E600GAC,ttyS0,115200,$$(e600gac_mtdlayout_16M),RKuImage))
