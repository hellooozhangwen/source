/*
 *  Whqx E600G reference board support
 *
...
#define E600G_GPIO_LED_LINK4	11
#define E600G_GPIO_LED_WLAN	12
#define E600G_GPIO_LED_DS10	13 /***SYS_LED***/
#define E600G_GPIO_LED_LINK3    14 
...
#define E600G_MAC0_OFFSET	0x1000
...
static struct gpio_led e600g_leds_gpio[] __initdata = {
	{
		...
		.name		= "e600g:green:link2",
		.gpio		= E600G_GPIO_LED_LINK2,
		.active_low	= 1,
	},{
		.name		= "e600g:green:link1",
...
{
	ath79_gpio_direction_select(E600G_GPIO_LED_LINK2, true);
	ath79_gpio_direction_select(E600G_GPIO_LED_LINK1, true);
...
static void __init e600g_setup(void)
{
	...
	ath79_register_wmac(art + E600G_MAC0_OFFSET, NULL);
...
MIPS_MACHINE(ATH79_MACH_E600G, "E600G", "E600G", e600g_setup);
